namespace Fireball.Game.Client.Modules
{
    public class FireballGCIEvent
    {
        ...
        public const string EVENT_OPERATOR_CONFIRMED_ACTION = "operator_confirmed_action";// added
        public const string EVENT_OPERATOR_PAUSE_GAME = "operator_pause_game";// added
        public const string EVENT_OPERATOR_CLOSE_GAME = "operator_close_game";// added
